...
Primero, verifica si tienes instalado Laravel Installer ejecutando el siguiente comando en tu terminal: `laravel --version`. Si no tienes Laravel Installer instalado, asegúrate de tener PHP y Composer previamente instalados en tu sistema. Luego, instala Laravel Installer con el siguiente comando en tu terminal:
...
Ahora, abre la terminal o línea de comandos en la ubicación donde deseas crear tu proyecto y escribe el siguiente comando: `composer create-project laravel/laravel usuario-publicaciones`. Esto creará un nuevo proyecto Laravel llamado `usuario-publicaciones`.
...
A continuación, tendrás que configurar Breeze con el _stack_ de Blade. Sigue los [comandos](https://laravel.com/docs/starter-kits#breeze-and-blade) indicados en la documentación de [Laravel Breeze](https://laravel.com/docs/starter-kits).
...
El _layout_ principal de la aplicación será `resources/views/layouts/core.blade.php`. Para ello, en `resources/views/layouts/` crea el archivo `core.blade.php` y pon el siguiente código:
