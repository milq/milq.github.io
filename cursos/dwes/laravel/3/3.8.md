...
A continuación, accede a `http://localhost:8000/inicio` para iniciar la aplicación web.

Si en algún momento deseas regresar a la página de inicio, simplemente navega hacia `http://localhost:8000/inicio`.
