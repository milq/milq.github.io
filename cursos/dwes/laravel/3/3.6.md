...
A continuación, resuelve el siguiente ejercicio:
...
Íntentalo por ti mismo. Si ves que no puedes, se muestra una propuesta para la resolución de este ejercicio.
